...
const AboutUs2 = () => {
  ...
  return (
    <section id="about" className="section-padding p-2 md:p-4 bg-gray-50 overflow-hidden">
      <div className="bg-gray-50 w-full text-slate-900 rounded-3xl mx-auto py-24 md:py-32 transition-colors duration-1000">
        <motion.div 
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
        ...
        >
          <div className="flex flex-col lg:flex-row justify-between items-start gap-12 mb-16 px-6">
            {/* Tabs - Mini version */}
            <motion.div variants={fadeInUp} className="inline-flex p-1 bg-white backdrop-blur-md rounded-full border border-slate-200 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:h-[600px] px-6">
            ...
            <div className="order-2 lg:order-1 col-span-1 md:col-span-2 lg:col-span-2 flex flex-wrap gap-4 items-start content-start">
              <motion.div variants={fadeInUp} className="max-w-2xl mb-2">
            ...
            <motion.div variants={fadeInUp} className="order-1 lg:order-2 col-span-1 md:col-span-2 lg:col-span-2 relative h-[400px] md:h-[600px] lg:h-full rounded-3xl overflow-hidden group shadow-2xl">
