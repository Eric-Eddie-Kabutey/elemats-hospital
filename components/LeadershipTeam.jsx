    ...
    management: [
      {
        ...
        image: "/career/banner/1 (4).jpg"
      },
      {
        name: "Musa Njie",
        role: "Client Relations Manager",
        image: "/career/banner/1 (5).jpg"
      },
      {
        name: "Fatou Sanneh",
        role: "Chief Financial Officer",
        image: "/career/banner/1 (6).jpg"
      }
    ]
  };
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {currentTeam.map((member, index) => (
            <div 
              key={index}
              className="bg-white rounded-4xl overflow-hidden shadow-xs hover:shadow-xl transition-all duration-500 group border border-slate-100"
            >
              {/* Image Container */}
