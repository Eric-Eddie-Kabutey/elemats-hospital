  ...
  return (
    <section className="section-padding bg-white overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 text-center">
        ...
        >
          We are a <span className="text-primary font-normal">leading private specialist</span> hospital — blending <br className="hidden lg:block" />
          <span className="text-primary font-normal">clinical precision, cutting-edge technology, and deep compassion</span> to <br className="hidden lg:block" />
