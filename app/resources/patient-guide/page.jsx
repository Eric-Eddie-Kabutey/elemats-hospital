          ...
          <div className="w-full max-w-7xl mx-auto py-24 px-6 md:px-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-24">
              ...
              <div className="space-y-8">
                <h2 className="text-4xl md:text-5xl lg:text-7xl font-normal text-slate-900 leading-[1.1] tracking-tight">
                  Providing care centered around <span className="text-primary italic">you.</span>
                </h2>
              ...
              <div className="space-y-6">
                {PATIENT_GUIDE_DATA.map((item, index) => (
                  <div key={index} className="group p-8 md:p-10 bg-white rounded-4xl border border-neutral-100 shadow-sm hover:shadow-xl transition-all duration-500">
      ...
      <section className="py-24 px-6 md:px-12 bg-white text-center">
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            <button className="bg-primary text-white px-10 py-5 rounded-full font-bold shadow-xl shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] transition-all">
              Contact Guest Relations
            </button>
            <button className="bg-slate-100 text-slate-900 px-10 py-5 rounded-full font-bold hover:bg-slate-200 transition-all">
